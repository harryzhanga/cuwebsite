...
<section class = "committee">
    <div class = "committee-container">
        <h1 class = "committee__title section-title">
        ...
        <div class="committee-carousel carousel slide" data-ride="carousel" data-interval="false">
          <div class="carousel-inner committee-carousel__inner ">
              <div class="carousel-item committee-carousel__item active">
                  <div class = "committee-carousel__img committee-carousel__img--president"></div>
                  <div class = "committee-carousel__content">
                      <div class = "committee-carousel__name">
                         Joseph Daffy
                      </div>
                      <div class = "committee-carousel__title">
                        President
                      </div>
              ...
              <div class="carousel-item committee-carousel__item">
                  <div class = "committee-carousel__img committee-carousel__img--vice-president"></div>
                  <div class = "committee-carousel__content">
                      <div class = "committee-carousel__name">
                         Sophie Pickavance
                      </div>
              ...
              <div class="carousel-item committee-carousel__item">
                  <div class = "committee-carousel__img committee-carousel__img--vice-president-2"></div>
                  <div class = "committee-carousel__content">
                      <div class = "committee-carousel__name">
                         Brandon Hao
                      </div>
              ...
              <div class="carousel-item committee-carousel__item">
                  <div class = "committee-carousel__img committee-carousel__img--secretary"></div>
                  <div class = "committee-carousel__content">
                      <div class = "committee-carousel__name">
              ...
              <div class="carousel-item committee-carousel__item">
                  <div class = "committee-carousel__img committee-carousel__img--treasurer"></div>
                  <div class = "committee-carousel__content">
                      <div class = "committee-carousel__name">
                         Zi En Tan
                      </div>
  ...
  Zi-En is a second-year science student planning to major in chemical engineering. He is eager to see how God will use the Christian Union to reach out, build up and send out the people of Melbourne University. Zi-En is serving as the treasurer from 2018-2019 and is excited to be able to serve God and the Christian Union alongside the rest of the committee. He hopes that the work of the Christian Union would be pleasing to God and that we would be a demonstration to the campus of the love of Christ. In his spare time, he enjoys playing computer games, listening to music, cooking and talking with friends.
              ...
              <div class="carousel-item committee-carousel__item">
                  <div class = "committee-carousel__img committee-carousel__img--media"></div>
                  <div class = "committee-carousel__content">
                      <div class = "committee-carousel__name">
                         Jakob Bradbeer
                      </div>
              ...
              <div class="carousel-item committee-carousel__item">
                  <div class = "committee-carousel__img committee-carousel__img--missions"></div>
                  <div class = "committee-carousel__content">
                      <div class = "committee-carousel__name">
                         Zoe Donnan
                      </div>
          ...
          <a href=".committee-carousel" data-slide="prev"  class="committee-carousel__button committee-carousel__button--left">
              <i class="fas fa-chevron-left fa-3x"></i>
          </a>
          <a href=".committee-carousel" data-slide="next" class="committee-carousel__button committee-carousel__button--right">
...
<section class = "faculty-section">
    ...
    <div class = "faculty-leaders">
        <div class = "faculty-leader">
            <div class = "faculty-leader__picture faculty-leader--arts"></div>
            <h2 class = "faculty-leader__faculty">Arts</h2>
            <h3 class = "faculty-leader__names">Tom Ricketts and Steph Herbert</h2>
        </div>
        <div class = "faculty-leader">
            <div class = "faculty-leader__picture faculty-leader--biomedicine"></div>
            <h2 class = "faculty-leader__faculty">Biomedicine</h2>
            <h3 class = "faculty-leader__names">Sam Shien Wenn and Eloise Ferguson</h2>
        </div>
        <div class = "faculty-leader">
            <div class = "faculty-leader__picture faculty-leader--commerce"></div>
            <h2 class = "faculty-leader__faculty">Commerce</h2>
            <h3 class = "faculty-leader__names">Jeffrey Yeap and Joel Lau</h2>
        </div>
        <div class = "faculty-leader">
            <div class = "faculty-leader__picture faculty-leader--design"></div>
            <h2 class = "faculty-leader__faculty">Design</h2>
            <h3 class = "faculty-leader__names">Robert Doherty and Dariyn Girton</h2>
        </div>
        <div class = "faculty-leader">
            <div class = "faculty-leader__picture faculty-leader--science"></div>
            <h2 class = "faculty-leader__faculty">Science</h2>
            <h3 class = "faculty-leader__names">Joshua Griffin and Julia Malan</h2>
        </div>
        <div class = "faculty-leader">
		    ...
		    <div id = "Connect_With_Us" class = "tab-pane fade  in active">
		    	<iframe src="https://docs.google.com/forms/d/1OihZMal4i-d8myyj80v37i0GCVEuee6IVpO2pr6bqIU/viewform?embedded=true" height = "3000" width="50%" frameborder="0" marginheight="0" marginwidth="0">Loading...</iframe>
<!-- 		   	<iframe src="https://docs.google.com/forms/d/1OihZMal4i-d8myyj80v37i0GCVEuee6IVpO2pr6bqIU/viewform?embedded=true" class="col-sm-6" height="1200" width="100%" frameborder="0" marginheight="0" marginwidth="0">Loading...</iframe> -->
